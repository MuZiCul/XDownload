...
export const en: Record<string, string> = {
  ...
  "gbar.deepLinkQueuedBatch": "Added {n} download tasks",
  ...
  "tasks.errShow": "View reason",
  "tasks.errHide": "Hide reason",
  ...
  // ===== Statistics =====
  "stats.open": "Stats",
  "stats.openTitle": "Open download statistics",
  "stats.title": "Download Statistics",
  "stats.refresh": "Refresh",
  "stats.heroTitle": "Your downloads, at a glance.",
  "stats.heroSubtitle": "Explore your download footprint on this device.",
  "stats.loading": "Loading statistics…",
  "stats.retry": "Retry",
  "stats.chartLoading": "Loading charts…",
  "stats.empty": "No downloads yet. Grab a video and come back.",
  "stats.totalDownloads": "Total Downloads",
  "stats.totalSize": "Total Storage",
  "stats.successRate": "Success Rate",
  "stats.usageDays": "Days Used",
  "stats.avgDuration": "Avg duration {d}",
  "stats.totalRecords": "{n} records",
  "stats.failed": "{n} failed",
  "stats.trendTitle": "Download Trend",
  "stats.trendSubtitle": "Successful downloads per day",
  "stats.sourceTitle": "By Source",
  "stats.sourceSubtitle": "Downloads grouped by task source",
  "stats.uploaderTitle": "Top Creators",
  "stats.uploaderSubtitle": "Video creators you downloaded most",
  "stats.handleTitle": "Top Accounts",
  "stats.handleSubtitle": "X accounts you downloaded most",

  // ===== Logs =====
  "logs.title": "Log Viewer",
  "logs.fileTitle": "Switch log file by date",
  "logs.levelTitle": "Filter by level",
  "logs.levelAll": "All",
  "logs.autoRefresh": "Auto refresh (2s)",
  "logs.refresh": "Refresh",
  "logs.toLatest": "Back to latest",
  "logs.shown": "{n} / {total} lines",
  "logs.loadError": "Failed to load logs: {err}",
  "logs.empty": "（No matching log lines）",
  "logs.noFiles": "（No log files yet）",
  ...
  "tools.downloadFail": "{tool} download failed",
  "tools.retry": "Retry",
  "tools.slowTitle": "Download is slow",
  "tools.slowBody": "Still downloading after 3 minutes. Keep waiting?",
  "tools.keepWaiting": "Keep waiting",
  "tools.manualDownload": "Download from website",
  "tools.openFail": "Failed to open download page",
  "tools.guideTip":
